...
set_input_transition $input_transition_min_worst -min [get_ports "in_DEMUX_inSEL2"]
...
set_input_transition $input_transition_min_worst -min [get_ports "in_MUX_inSEL3"]
set_input_transition $input_transition_min_worst -min [get_ports "in_MUX_inSEL11"]
set_input_transition $input_transition_min_worst -min [get_ports "in_MUX_inSEL12"]
set_input_transition $input_transition_min_worst -min [get_ports "in_DEMUX_inSEL17"]
...
set_input_transition $input_transition_max_worst -max [get_ports "in_DEMUX_inSEL2"]
...
set_input_transition $input_transition_max_worst -max [get_ports "in_MUX_inSEL3"]
set_input_transition $input_transition_max_worst -max [get_ports "in_MUX_inSEL11"]
set_input_transition $input_transition_max_worst -max [get_ports "in_MUX_inSEL12"]
set_input_transition $input_transition_max_worst -max [get_ports "in_DEMUX_inSEL17"]
...
set_load -pin_load $std_load_worst -min [get_ports "in_DEMUX_inSEL2"]
...
set_load -pin_load $std_load_worst -min [get_ports "in_MUX_inSEL3"]
set_load -pin_load $std_load_worst -min [get_ports "in_MUX_inSEL11"]
set_load -pin_load $std_load_worst -min [get_ports "in_MUX_inSEL12"]
set_load -pin_load $std_load_worst -min [get_ports "in_DEMUX_inSEL17"]
