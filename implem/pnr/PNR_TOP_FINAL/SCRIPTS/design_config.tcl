...
globalNetConnect gnd3r! -type pgpin -pin gnd3r! -inst GND3 -module {}
globalNetConnect gnd3o! -type pgpin -pin gnd3o! -inst GND3 -module {}
globalNetConnect vdd3r1! -type pgpin -pin vdd3r1! -inst GND3 -module {}
globalNetConnect vdd3r2! -type pgpin -pin vdd3r2! -inst GND3 -module {}
globalNetConnect vdd3o! -type pgpin -pin vdd3o! -inst GND3 -module {}

globalNetConnect gnd3r! -type pgpin -pin gnd3r! -inst PWR4 -module {}
globalNetConnect gnd3o! -type pgpin -pin gnd3o! -inst PWR4 -module {}
globalNetConnect vdd3r1! -type pgpin -pin vdd3r1! -inst PWR4 -module {}
globalNetConnect vdd3r2! -type pgpin -pin vdd3r2! -inst PWR4 -module {}
globalNetConnect vdd3o! -type pgpin -pin vdd3o! -inst PWR4 -module {}

globalNetConnect gnd3r! -type pgpin -pin gnd3r! -inst GND4 -module {}
globalNetConnect gnd3o! -type pgpin -pin gnd3o! -inst GND4 -module {}
globalNetConnect vdd3r1! -type pgpin -pin vdd3r1! -inst GND4 -module {}
globalNetConnect vdd3r2! -type pgpin -pin vdd3r2! -inst GND4 -module {}
globalNetConnect vdd3o! -type pgpin -pin vdd3o! -inst GND4 -module {}
...
globalNetConnect vdd! -type pgpin -pin A -inst PWR4 -module {}
...
globalNetConnect gnd! -type pgpin -pin A -inst GND4 -module {}
